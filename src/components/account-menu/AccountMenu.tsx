...
const AccountMenu: React.FC = () => {
    return (
        <div className="!p-3 !bg-white flex flex-col gap-1 w-50 h-auto">
            <div className="w-full !p-2 !py-1.5 flex items-center justify-start gap-1 cursor-pointer text-black hover:bg-[#1c2635] hover:text-white transition-all duration-300">
